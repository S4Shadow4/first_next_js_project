  ...
  return (
    <div className="w-full md:col-span-4">
      ...
      <div className="rounded-xl bg-gray-200 p-4">
        <div className="mt-0 grid grid-cols-12 items-end gap-2 rounded-md bg-gray-200 p-4 sm:grid-cols-13 md:gap-4">
          <div
          ...
          {income.map((month) => (
            <div key={month.month} className="flex flex-col items-center gap-2">
              <div
                className="w-full rounded-md bg-[#8DC03F]"
                style={{
        ...
        <div className="flex items-center pb-2 pt-6">
          ...
          <h3 className="ml-2 text-sm text-gray-400 ">This year</h3>
        </div>
      </div>
    </div>
  );
